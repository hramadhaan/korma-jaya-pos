<template>
  <div class="w-full min-h-screen">
    ...
    <div v-else class="h-screen justify-center flex items-center flex-col">
      <center class="">
        <svg
          class="emoji-404"
        ...
        <div class="tracking-widest mt-4">
          ...
          <span class="text-gray-500 text-xl"
            >Token tidak ditemukan, harap ulangi lagi</span
          >
        </div>
      </center>
      <center class="mt-6">
        <NuxtLink
          to="https://korma-jaya-dashboard.shopnstore.my.id"
          class="text-gray-500 font-mono text-base bg-gray-200 p-3 rounded-md hover:shadow-md"
          >Kembali
        </NuxtLink>
      </center>
    </div>
